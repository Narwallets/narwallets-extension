...
function updateNetworkIndicatorVisualState(info) {
...
function selectNetworkClicked(ev) {
    ...
    selectionBox.querySelectorAll("div.circle").forEach((div) => {
...
async function saveSecurityOptions(ev) {
    try {
        ev.preventDefault();
        const checkElem = document.getElementById("advanced-mode");
