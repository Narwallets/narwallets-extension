...
import { StakingPoolAsset } from "../data/account.js";
...
export class LockupContract {
    ...
    async setStakingPoolInfo(contractKnownPoolDeposited) {
        const stakingPoolName = await askBackgroundViewMethod(this.contractAccount, "get_staking_pool_account_id", {});
        if (stakingPoolName) {
    ...
    //-------------------------------------------
    async getStakingPoolAccInfo(stackingPoolName) {
        if (!stackingPoolName)
