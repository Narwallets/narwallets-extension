...
//-------------------------------
export function broadcast_tx_commit_signed(
...
//-------------------------------
export async function broadcast_tx_commit_actions(
  actions: TX.Action[],
  signerId: string,
  receiver: string,
  privateKey: string
